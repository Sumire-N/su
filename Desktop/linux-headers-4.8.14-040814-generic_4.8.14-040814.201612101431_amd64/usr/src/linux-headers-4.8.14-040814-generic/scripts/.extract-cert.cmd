cmd_scripts/extract-cert := gcc -Wp,-MD,scripts/.extract-cert.d -Iscripts -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89  -I/home/kernel/COD/linux/tools/include -o scripts/extract-cert /home/kernel/COD/linux/scripts/extract-cert.c  -lcrypto

source_scripts/extract-cert := /home/kernel/COD/linux/scripts/extract-cert.c
